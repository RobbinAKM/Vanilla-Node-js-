...
handlers.exampleHandler=function(){
  var err = new Error('un unknown error has occured');
  throw(err);
}
...
/* everything below here is JSON API handlers */
